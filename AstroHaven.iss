...
#define MyAppName "Astro Haven X2 PlugIn"
...
OutputBaseFilename=AstroHaven_X2_Installer
...
Source: "domelist AstroHaven.txt";                          DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 AstroHaven.txt"
; 32 bits
Source: "libAstroHaven\Win32\Release\libAstroHaven.dll";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libAstroHaven\x64\Release\libAstroHaven.dll";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
